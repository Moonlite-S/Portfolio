...
export function BoxedDiv(
  ...
  return (
    <motion.div className=' bg-red-400/10 mx-auto rounded-md my-2 p-4 text-xl backdrop-blur-md lg:max-w-2xl md:max-w-lg max-w-xs min-w-10' variants={item}>
      {children}
    </motion.div>
  )
}
...
function RectSVG(
  {y, size, reverse, delay}: RectProps
) {

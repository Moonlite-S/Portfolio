  ...
  return (
      <BoxedDiv>
        ...
        <div className="text-center mx-5 my-3">
          ...
          <h2 className="ResponsiveTextLg ResponsiveFontLight">Hello!</h2>
          ...
          <p className="ResponsiveTextSm ResponsiveFontLight indent-4 mt-4">
            My passion for web dev started back in high school where I was in a intro to web dev class. The idea of combining my creative imagination and programming was incredibly exciting. Nowadays, I like to make a variety of projects in the name of fun while also having a passion for learning new things.
          </p>
